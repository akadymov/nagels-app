                ...
                <div className={`game-table ${ this.props.isMobile ? "mobile" : (this.props.isDesktop ? "desktop" : "tablet")} ${ this.props.isPortrait ? "portrait" : "landscape"} ${this.Cookies.get('colorScheme')}`}>
                            ...
                            if(this.state.gameDetails.positionsDefined){
                                return (
                                    <OpponentContainer
                                        ...
                                        onboarding={this.Cookies.get('onboardingGame') === '4' && onboarding}
                    ...
                    {this.state.gameDetails.positionsDefined && this.state.gameDetails.myInHandInfo.dealtCards && !this.state.replayMode ? 
                        <PlayerContainer
                            ...
                            onboarding={this.Cookies.get('onboardingGame') === '5' && onboarding}
                    ...
                    {this.state.gameDetails.currentHandId ?
                        <div 
                            ...
                            style={{
                                outline: this.Cookies.get('onboardingGame') === '3' && onboarding ? '2px solid ' + (this.Cookies.get('colorScheme') === 'piggy' ? defaultTheme.palette.primary.piggy : defaultTheme.palette.primary.main) : 'unset',
                                boxSizing: 'border-box',
                                borderRadius: '2px',
                                zIndex: this.Cookies.get('onboardingGame') === '3' && onboarding ? 102 : 'unset'
                            }}
                        >
